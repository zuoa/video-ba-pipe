...
class Orchestrator:
    ...
    def _build_shared_inference_controller(
        ...
        return SharedInferenceServiceController(
            ...
            gpu_scheduling_enabled=config.gpu_scheduling_enabled,
            gpu_allowed_devices=config.gpu_allowed_devices,
            gpu_memory_reserve_mb=config.gpu_memory_reserve_mb,
            gpu_new_model_default_mb=config.gpu_new_model_default_mb,
            gpu_model_memory_margin_percent=(
                config.gpu_model_memory_margin_percent
            ),
            gpu_oom_cooldown_seconds=config.gpu_oom_cooldown_seconds,
            gpu_nvml_stale_seconds=config.gpu_nvml_stale_seconds,
            gpu_failure_mode=config.gpu_failure_mode,
        ...
        models = [
            {
                ...
                "reserved_gpu_mb": item.get("reserved_gpu_mb"),
                "actual_gpu_mb": item.get("actual_gpu_mb"),
                "gpu_retry_count": item.get("gpu_retry_count"),
